...
const styles = {
  ...
  selectInput: "min-w-[132px] cursor-pointer appearance-none rounded-[5px] border border-brd2 bg-transparent bg-[url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 width=%279%27 height=%275%27 viewBox=%270 0 9 5%27%3E%3Cpath d=%27M0 0l4.5 5L9 0z%27 fill=%27%23444%27/%3E%3C/svg%3E')] bg-[position:right_8px_center] bg-no-repeat px-[10px] py-[6px] pr-[28px] font-sans text-xs font-normal text-t3 outline-none transition-all",
...
export default function LldTable() {
